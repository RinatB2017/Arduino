...
void setup()
{
  ...
  ledDriver.begin(0xC0);  // Address pins A5-A0 set to B111000
  ledDriver.init();
...
d
  ...
  {
    ledDriver.setLEDDimmed(n,   0);
    ledDriver.setLEDDimmed(n+1, 1);
  }
  delay(1000);
  for(int n=0; n<16; n+=2)  
  {
    ledDriver.setLEDDimmed(n,   1);
    ledDriver.setLEDDimmed(n+1, 0);
  }
  delay(1000);
#endif
