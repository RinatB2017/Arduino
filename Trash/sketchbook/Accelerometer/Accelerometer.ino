...
void loop()
{
  ...
  gy.body.ACC.x = accel_angle_x;
  gy.body.ACC.y = accel_angle_y;
  gy.body.ACC.z = accel_angle_z;
  
  gy.body.GYR.x = unfiltered_gyro_angle_x;
  gy.body.GYR.y = unfiltered_gyro_angle_y;
  gy.body.GYR.z = unfiltered_gyro_angle_z;
  
  gy.body.FIL.x = angle_x;
  gy.body.FIL.y = angle_y;
  gy.body.FIL.z = angle_z;
