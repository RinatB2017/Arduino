...
const int num_strip = 2;            // количество полос
const int cnt_led_in_strip = 50;    // количество светодиодов в полосе
...
void clear_all()
{
  ...
  solid_strip_6.clear(cnt_led_in_strip);
}
//-----------------------------------------------------------------------------
void setup()
{
...
void draw_solid_line()
{
  ...
  solid_strip_6.sendPixels(cnt_led_in_strip, pixels);
}
//-----------------------------------------------------------------------------
void draw_line()
{
